      ...
      <section className="section terms-section">
        <div className="container">
          ...
          <div className="terms-content">
            ...
            <h2>1. Terms</h2>
            <p>
              By accessing the website at culturez.com, you are agreeing to be bound by these 
            ...
            <ol type="a">
              <li>
                ...
                (information or software) on Culturez's website for personal, 
                non-commercial transitory viewing only. This is the grant of a license, 
                not a transfer of title, and under this license you may not:
                <ol type="i">
                  <li>modify or copy the materials;</li>
                  <li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
                  <li>attempt to decompile or reverse engineer any software contained on Culturez's website;</li>
              ...
              <li>
                ...
                restrictions and may be terminated by Culturez at any time. 
            ...
            <h2>3. Disclaimer</h2>
            <p>
              The materials on Culturez's website are provided on an 'as is' 
              basis. Culturez makes no warranties, expressed or implied, 
            ...
            <h2>4. Limitations</h2>
            <p>
              In no event shall Culturez or its suppliers be liable for any 
              ...
              the materials on Culturez's website, even if Culturez 
              or a Culturez authorized representative has been notified 
            ...
            <p>
              The materials appearing on Culturez's website could include 
              technical, typographical, or photographic errors. Culturez 
              does not warrant that any of the materials on its website are accurate, 
              complete or current. Culturez may make changes to the materials 
              contained on its website at any time without notice. However Culturez 
              does not make any commitment to update the materials.
            </p>
            
            <h2>6. Links</h2>
            <p>
              Culturez has not reviewed all of the sites linked to its 
              website and is not responsible for the contents of any such linked site. 
              The inclusion of any link does not imply endorsement by Culturez 
              of the site. Use of any such linked website is at the user's own risk.
            </p>
            
            <h2>7. Modifications</h2>
            <p>
              Culturez may revise these terms of service for its website at 
